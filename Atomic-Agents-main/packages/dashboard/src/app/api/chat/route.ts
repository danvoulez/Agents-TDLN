...
async function queueJob(
  ...
  // Notify frontend that a job was created
  try {
    broadcastToConversation(state.conversationId, { type: "job_created", jobId: job.id, redirect: true });
  } catch (e) {
    console.error("broadcast job_created failed", e);
  }
